...
<html>
    ...
    <script type="text/javascript">
	   ...
	   //load数据到修改页面
		var loadPageData = function(scid) {
			...
			//读取表单数据，并为表单赋值
			ServiceBreak(scClassName, "loadFormData", [JSON.stringify(tableObj)], function(data) {//debugger;
				if(data == null) return;
  ...
  <body>
	<div>
		...
		<input type="hidden" id="scid" /><input class="scSave ipt"  type="hidden" id="scstatus"  name="scstatus" value="0"/>
		受理日期：<input class="scSave ipt"  type="text" id="executeDate"  name="executeDate" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		受理编号: <input class="scSave ipt"  type="text" id="projectNum"  name="projectNum"/><br/><br/>
	   </div>
		  <h1 align = "center">化学品物理危险性鉴定仲裁申请表</h1>
		<div>
			<table border="0" align="center" width="500">
				<tr><td width="80">申请单位：</td><td colspan="7"><input class="scSave ipt"  type="text" id="applyCom" size="50"   name="applyCom"/></td></tr>
				<tr><td>经&nbsp;办&nbsp;人：</td><td colspan="7"><input class="scSave ipt"  type="text" id="executePeople" size="50"  name="executePeople"/></td></tr>
				<tr><td>联系电话：</td><td colspan="7"><input class="scSave ipt"  type="text" id="phone" size="50"  name="phone"/></td></tr>
				<tr><td>移动电话：</td><td colspan="7"><input class="scSave ipt"  type="text" id="mobilePhone"  size="50" name="mobilePhone"/></td></tr>
				<tr><td>传&nbsp;&nbsp;真：</td><td colspan="7"><input class="scSave ipt"  type="text" id="fax" size="50"  name="fax"  /></td></tr>
				<tr><td>电子邮箱：</td><td colspan="7"><input class="scSave ipt"  type="text" id="email" size="50"  name="email"/></td></tr>
				<tr><td>填表日期：</td><td colspan="7"><input class="scSave ipt"  type="text" id="createtabledate" name="createtabledate" size="50" /></td></tr>
			</table>
		<br />
		<br />
		<br />
    	...
    	<h2 align = "center">国家安全生产监督管理总局制样</h2><hr/>
   		...
   		<div style="position:absolute;left:270px;top:500px;right:350px">
   			...
   			<table  border="0" align="center" width="700">
		    	...
		    	<tr>
		    		<td width="100"> 化学品中文名称：</td><td><input  class="scSave ipt"   type="text" size="52" id="chnName"   name="chnName"/></td>
		    	</tr>
		    	<tr>
		    		<td>化学品英文名称：</td><td><input class="scSave ipt"  type="text" size="52" id="chnEngName"   name="chnEngName" /></td>
		    	</tr>
		    	<tr>
		    		<td>化学品中文别名：</td><td><input class="scSave ipt"  type="text" size="52" id="chnAlies"   name="chnAlies"/></td>
		    	</tr>
	    	</table>
   			<h3>2、申请鉴定仲裁内容</h3>
   			<p>
   				 我单位于<input class="scSave ipt"  type="text" id="applydate" name="applydate" size="6"  />年/月/日
				...
				该鉴定机构于
   				<input class="scSave ipt"  type="text" id="report_finish_date" name="report_finish_date" size="6"  />年/月/日
			...
			<br/><br/>
			<table width="550">
				<tr><td>经办人（签字）：<input class="scSave ipt" type="text" id="executePeopleqz" name="executePeopleqz"/></td></tr>
				<tr><td>单位负责人（签字）：<input  class="scSave ipt"  type="text" id="responsible_person"   name="responsible_person" /></td></tr>
				<tr><td></td></tr>
				<tr><td align="right">（申请单位公章）</td></tr>
				<tr><td align="right">
					<input class="scSave ipt"  type="text" id="seal_date" name="seal_date" size="12" />年/月/日   
				</td></tr>
			</table><br/><br/>
			<h3>3、其他需要说明的事项</h3>
			<p><textarea rows="7"  class="scSave ipt" cols="70" id="instructions"   name="instructions"></textarea></p>
				<p>&nbsp;&nbsp;&nbsp;
				...
				<p align="right">受理人（签字）：<input class="scSave ipt"  type="text" id="acceptance_pepple"   name="acceptance_pepple" /></p>
			<p><h5>注：如果是系列鉴定，且仲裁送检样品超过1个时，“化学品信息”栏中的“化学品中文名称”
			 	应填写所有送检样品的名称，“化学品英文名称”、“其他名称”可以不填。</h5></p>

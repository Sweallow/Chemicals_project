...
<html>
	...
	<title>查看化学品物理危险性分类报告</title>
		...
		<script type="text/javascript">
			...
			$(function() {
				...
				top.sc.indexAutoHeight(3400);//固定液面高度
  ...
  <body>
	...
	<!--  
	    ...
	    <h2>二、单位属性</h2>
	    <p>封面“单位属性”根据单位基本情况，按照“生产”、“进口”、“使用”、“经营（不含进口）”、“储存”、“运输”、“其他”
		的顺序选择填写。例如申请鉴定单位属于化学品生产单位，同时又进口化学品，或者使用化学品，则仅填写“生产”。</p>
	  	<h2>三、化学品基本信息</h2>
